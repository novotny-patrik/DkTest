...
if (window.location.href.includes('try=confirm')) {
    ...
    function extracted(delayTime, input, inputMs) {
    ...
    document.getElementById("arrTime").onclick = function () {
        ...
        extracted(delayTime, input, inputMs);
    };
        ...
        function renderPlanRows(plan, id) {
            ...
            for (let i = 0; i < plan.length; i++) {
                ...
                if (isPlace && window.location.href.includes('try=confirm')) {
                    ...
                    let targetId = document.querySelector("#command-data-form > div:nth-child(9) > table > tbody > tr:nth-child(2) > td:nth-child(2) > span").dataset.id;
                    if (targetId === row.targetVillageId + "") {
                        ...
                        if (!extractedCalled) {
                            extracted(delayTime, inputLc, inputMsLc);
